...
export default function InvoicesCreate({ clients }) {
    ...
    function submit(e) {
        ...
        post(route('admin.invoices.store'), {
            onSuccess: () => window.location.href = route('admin.invoices.index'),
        });
    }

    return (
        <AppLayout title="Créer une facture">
            ...
            <div className="max-w-2xl mx-auto space-y-6">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <h1 className="text-lg font-bold text-gray-800 dark:text-gray-100">Nouvelle facture</h1>
                </div>
                ...
                <form onSubmit={submit} className="space-y-6">
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-xl px-4 py-3">
                        💡 La facture sera créée en brouillon. Vous pourrez ajouter les lignes depuis la page de détail.
                    </p>
